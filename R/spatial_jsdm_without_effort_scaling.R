...
out = stan(file = 'stan/spatial_jdsm_without_effort_scaling.stan', data = dat, iter = 20, warmup = 10, chains = 1, cores = 1)

# saveRDS(out, "data/stan_jdsm_without_effort_scaling.rds")

# out = read_rds('data/stan_jdsm_without_effort_scaling.rds')
