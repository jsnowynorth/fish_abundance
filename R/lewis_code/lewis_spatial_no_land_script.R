...
save_pars_no_land = create_pars(fish_dat, mean_covs, mean_covs_log, mean_covs_logit, catch_covs)
...
saveRDS(run, file = '/home/jntmf/data/fish/results/no_land/full_model_no_land.rds')
saveRDS(run$pars, file = '/home/jntmf/data/fish/results/no_land/curr_pars_no_land_1.rds')
# saveRDS(run$pars, file = '/home/jntmf/data/fish/results/no_land/curr_pars_no_land_2.rds')
# saveRDS(run$pars, file = '/home/jntmf/data/fish/results/no_land/curr_pars_no_land_3.rds')
# saveRDS(run$pars, file = '/home/jntmf/data/fish/results/no_land/curr_pars_no_land_4.rds')
# saveRDS(run$pars, file = '/home/jntmf/data/fish/results/no_land/curr_pars_no_land_5.rds')