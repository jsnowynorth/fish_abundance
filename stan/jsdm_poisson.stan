...
transformed data{
  ...
  matrix[K,K] psi;
  real nu = 2 + K;
  psi = diag_matrix(rep_vector(11, K));
...
parameters {
  ...
  // cov_matrix[K] Sigma_species; // species covariance matrix
...
model {
  ...
  Sigma_species ~ lkj_corr(2); // Sigma_species prior
