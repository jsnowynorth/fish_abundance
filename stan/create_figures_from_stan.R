...
# out = read_rds('/Users/joshuanorth/Desktop/stan_spatial.rds')
...
for(j in 1:6){
  png(paste0('/Users/joshuanorth/Desktop/fish_chains/beta_', fnames[j], '.png'), width = 800, height = 600)
  par(mfrow = c(3,3))
  for(i in 1:8){
    plot(beta[,i,j], type = 'l', main = b_names[i])
    abline(h = 0)
  }
  dev.off()
}
...
for(j in 1:6){
  png(paste0('/Users/joshuanorth/Desktop/fish_chains/phi_', fnames[j], '.png'), width = 800, height = 600)
  par(mfrow = c(3,4))
  for(i in 1:11){
    plot(phi[,i,j], type = 'l', main = phi_names[i])
    abline(h = 0)
  }
  dev.off()
}
...
par(mfrow = c(3,6))
for(i in 001:003){
  plot(omega[, i,1], type = 'l', main = dat$fish_names[1])
  plot(omega[, i,2], type = 'l', main = dat$fish_names[2])
  plot(omega[, i,3], type = 'l', main = dat$fish_names[3])
  plot(omega[, i,4], type = 'l', main = dat$fish_names[4])
  plot(omega[, i,5], type = 'l', main = dat$fish_names[5])
  plot(omega[, i,6], type = 'l', main = dat$fish_names[6])
}


par(mfrow = c(2,3))
for(i in 1:6){
  plot(sigma_species[,5,i], type = 'l', main = dat$fish_names[i])
}
